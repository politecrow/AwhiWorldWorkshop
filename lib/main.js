...
function draw(){
  ...
  while(i < numberOfSides){
    ...
    var pos1y = (Math.cos((f + ((360 / numberOfSides) * i) * calibration)) * (cubeHeight * rotationAngle)) + (canvasCentreY + yOffset) * rotationAngle;
    ...
    */
    ...
    //Sides
    line(pos1x, pos1y + (canvasCentreY + yOffset) * rotationAngle, pos1x, pos1y * rotationAngle);
    text((i + 1), pos1x, pos1y - 5);
    //Top
    line(pos1x, pos1y, pos2x, pos2y + (cubeHeight * rotationAngle));
    //Bottom
    line(pos1x, pos1y + (canvasCentreY + yOffset) * rotationAngle, pos2x, pos2y);
